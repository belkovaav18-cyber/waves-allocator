...
SINGLE_ROOM_PEOPLE = [
    ...
    "Пирогов – МГУ",
    "Пятаков – МГУ",
    "Руденко – академик, МГУ",
    "Сазонов – НИЦ «Курчатовский институт»",
    "Сапожников – МГУ",
    "Тимофеев – ИФ СО РАН",
    "Храмов – РЭУ им. Г.В. Плеханова",
    "Цысарь – МГУ",
    "Чашечкин – ИПМех РАН",
    "Черепенин – академик, ИРЭ РАН",
    "Шандаров – ТУСУР",
    "Козарь – МГУ (председатель)",
    "Калиш – МГУ (секретарь)",
    "Архипов – ФТИ им. А.Ф. Иоффе",
    "Балакший – МГУ",
    "Белотелов – МГУ",
    "Боголюбов – МГУ",
    "Бородачев – МГУ",
